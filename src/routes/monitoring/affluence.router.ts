...
affluenceRouter.get('/daily/:enclosureId', authMiddleware, async function (req, res) {
...
affluenceRouter.get('/weekly/:enclosureId', authMiddleware, async function (req, res) {
...
affluenceRouter.get('/monthly-enclosure/:enclosureId/:month?', authMiddleware, async function (req, res) {
    await (await getAffluenceController()).monthlyEnclosureAffluence(req, res);
});
affluenceRouter.get('/monthly/:month?', authMiddleware, async function (req, res) {
    await (await getAffluenceController()).monthlyAffluence(req, res);
});

affluenceRouter.get('/yearly-enclosure/:enclosureId/:year?', authMiddleware, async function (req, res) {
    await (await getAffluenceController()).yearlyEnclosureAffluence(req, res);
});

affluenceRouter.get('/yearly/:year?', authMiddleware, async function (req, res) {
    await (await getAffluenceController()).yearlyAffluence(req, res);
});

affluenceRouter.get('/total/:enclosureId', authMiddleware, async function (req, res) {
...
affluenceRouter.get('/live/:enclosureId', authMiddleware, async function (req, res) {
