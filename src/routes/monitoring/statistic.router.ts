...
statisticRouter.get('/count/enclosure', authMiddleware, async function (req, res) {
...
statisticRouter.get('/count/animal/:enclosureId', authMiddleware, async function (req, res) {
    await (await getStatisticController()).enclosureAnimalCount(req, res);
});

statisticRouter.get('/count/pass/valid/types', authMiddleware, async function (req, res) {
    await (await getStatisticController()).validPassStatsByType(res);
});

statisticRouter.get('/count/pass/valid', authMiddleware, async function (req, res) {
    await (await getStatisticController()).validPassStats(res);
});

statisticRouter.get('/count/pass/expired', authMiddleware, async function (req, res) {
    await (await getStatisticController()).expiredPassStats(res);
});

statisticRouter.get('/count/pass/types', authMiddleware, async function (req, res) {
