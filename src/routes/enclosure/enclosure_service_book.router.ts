...
enclosureServiceBookRouter.delete("/:id", adminMiddleware, async function(req, res) {
...
enclosureServiceBookRouter.post("/", employeeMiddleware, async function(req, res) {
...
enclosureServiceBookRouter.put("/:id", employeeMiddleware, async function(req,res) {
    const controller = await Enclosure_Service_Book_Controller.getInstance();
...
enclosureServiceBookRouter.get("/:id", employeeMiddleware, async function(req, res) {
    const controller = await Enclosure_Service_Book_Controller.getInstance();
...
enclosureServiceBookRouter.get("/enclosure/:id", employeeMiddleware, async function(req, res) {
    const controller = await Enclosure_Service_Book_Controller.getInstance();
    const result = await controller.getAllFromEnclosure(Number.parseInt(req.params.id));
    if (result === null) {
        res.status(404).end();
        return;
    }
...
enclosureServiceBookRouter.get("/employee/:id", employeeMiddleware, async function(req, res) {
    const controller = await Enclosure_Service_Book_Controller.getInstance();
    const result = await controller.getAllFromEmployee(Number.parseInt(req.params.id));
    if (result === null) {
        res.status(404).end();
        return;
    }
...
enclosureServiceBookRouter.get("/", employeeMiddleware, async function(req, res) {
