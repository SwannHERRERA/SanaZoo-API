...
import {
  IEnclosure_Instance,
  IEnclosure_Type_Creation_Props,
...
export class Enclosure_Type_Controller {
  ...
  public static async getInstance(): Promise<Enclosure_Type_Controller> {
    if (Enclosure_Type_Controller.instance === undefined) {
      ...
      Enclosure_Type_Controller.instance = new Enclosure_Type_Controller(
        Enclosure,
        EnclosureType
      );
    }
  ...
  public async add(
    props: IEnclosure_Type_Creation_Props
  ): Promise<IEnclosure_Type_Instance | null> {
  ...
  public async getEnclosureByType(
    id: number
