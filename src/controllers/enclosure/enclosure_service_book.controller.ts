...
export class Enclosure_Service_Book_Controller {
  ...
  public static async getInstance(): Promise<Enclosure_Service_Book_Controller> {
    if (Enclosure_Service_Book_Controller.instance === undefined) {
      ...
      Enclosure_Service_Book_Controller.instance = new Enclosure_Service_Book_Controller(
        EnclosureServiceBook
      );
    }
  ...
  public async add(
    props: IEnclosure_Service_Book_Creation_Props
  ...
  public async getAllFromEnclosure(
    id: number
  ): Promise<IEnclosure_Service_Book_Instance[] | null> {
  ...
  public async getAll(
    param?: IEnclosure_Service_Book_Get_All_Params
  ): Promise<IEnclosure_Service_Book_Instance[] | null> {
