...
export class PassNightController {
  ...
  public static async getInstance(): Promise<PassNightController> {
    if (PassNightController.instance === undefined) {
      ...
      PassNightController.instance = new PassNightController(
        manager.Pass,
  ...
  public async getAllPassNightsAvailabilities(
    req: Request,
    res: Response
  ): Promise<void> {
  ...
  public async getAvailablePassNightsAvailabilities(
    req: Request,
    res: Response
  ): Promise<void> {
    const limit = req.query.limit
  ...
  public async getPassNighAvailability(
    req: Request,
    res: Response
  ): Promise<void> {
    const id = req.params.id;
    const passNightAvailability: IPass_Night_Availability_Instance | null = await this.PassNightAvailability.findByPk(
      id
    );
  ...
  public async createPassNightAvailability(
    req: Request,
    res: Response
  ): Promise<void> {
  ...
  public async updatePassNightAvailability(
    req: Request,
    res: Response
  ): Promise<void> {
    const date: Date | null = new Date(req.body.date);
  ...
  public async deletePassNightAvailability(
    req: Request,
    res: Response
  ): Promise<void> {
    const id = req.params.id;

    const isDeleted = await this.PassNightAvailability.destroy({
      where: { id },
    });
